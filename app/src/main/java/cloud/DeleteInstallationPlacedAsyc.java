...
//permet de delete les installationPlaced
public class DeleteInstallationPlacedAsyc  extends AsyncTask<Void, Void, Long> {

    private static InstallationPlacedApi installationPlacedApi = null;
    private DbHelper db;
    private long id =-1l;

    public DeleteInstallationPlacedAsyc(Long id) {
        this.id = id;
    }
    ...
    protected Long doInBackground(Void... params) {
        ...
        try {
            if (id != -1l)
                installationPlacedApi.remove(id).execute();
